...
const menuOptions = ["dashboard", "category", "medicine", "inventory", "sales", "supplier", "employee", "role", "log","statistics","purchase_order"];
const buttonOptions = ["category:add", "category:edit", "category:delete", "medicine:add", "medicine:edit", "medicine:delete", "inventory:in", "inventory:out", "sales:create", "supplier:add", "supplier:edit", "supplier:delete", "employee:add", "employee:edit", "employee:delete", "role:add", "role:edit", "role:delete", "log:view","purchase:add", "purchase:edit", "purchase:delete", "purchase:audit", "purchase:inbound", "purchase:export"];
